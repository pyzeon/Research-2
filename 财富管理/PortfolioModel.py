...
def calcEfficientFrontierWithoutConstraint(cov, mu, sigma=None, r=None, num=100):
...
#       1' * w = 1
#        0<=w<=1, if allow_short=False
def _calcEfficientFrontierNoShort(cov, mu, sigma=None, r=None, num=100):
    w = cvx.Variable(np.shape(mu)[0])
...
def calcEfficientFrontier(cov, mu, rf=None, allow_short=True, sigma=None, r=None, num=100):
